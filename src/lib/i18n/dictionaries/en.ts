...
export const en = {
  ...
  desk: {
    ...
    browserApp: {
      ...
      reload: 'Reload',
      search: 'Search',
      urlPlaceholder: 'Enter URL or search query',
    },
    readmeApp: {
      title: 'README.txt',
      close: 'Close',
  ...
  legal: {
    ...
    privacy: {
      ...
      s2intro: 'When you submit the contact form on this Site, I collect:',
      s2items: ['Your name', 'Your email address', 'The subject and content of your message'],
      s2after: 'I do not collect or log your IP address, and the contact form does not set cookies or tracking identifiers.',
      s3h: '3. How Information Is Used',
      s3intro: 'Information you submit is used solely to:',
      s3items: ['Respond to your enquiry or message'],
      s3after: 'The contact form is protected from automated spam by a hidden honeypot field rather than by collecting any data about you. Your data is never sold, shared with third parties for marketing, or used for any purpose beyond responding to your contact.',
      s4h: '4. Data Storage and Security',
      s4p1: 'This Site has no database. Contact form submissions are delivered to me by email through Resend (resend.com) and are not stored on the Site itself. Email is transmitted using TLS encryption.',
      s4p2: 'I use industry-standard encryption (TLS) for email transmission and follow best practices to keep your data secure.',
      s5h: '5. Retention',
      s5b: 'Because submissions are sent by email and not stored on the Site, retention is limited to my email records, kept only as long as necessary to respond to your enquiry and for reasonable record-keeping purposes. You may request deletion of your data at any time.',
      ...
      s6p3: 'The games in the Games section save your best score in your browser using local storage. That information stays on your device, is never transmitted to me or any third party, and you can clear it at any time through your browser settings.',
      s7h: '7. Your Rights',
