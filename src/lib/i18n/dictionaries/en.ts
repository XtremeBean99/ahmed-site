...
export const en = {
  ...
  catan: {
    ...
    settings: {
      ...
      boardKey: 'Board key',
      boardKeyHint: 'Show the board key panel in the sidebar',
      on: 'On',
      off: 'Off',
    },
    tooltips: {
    ...
    trade: {
      ...
      get: 'Get',
      rate: '{rate}:1',
      bankTrade: 'Trade with bank',
      playerTrade: 'Trade with {name}',
    ...
    playCard: {
      ...
      chooseTwo: 'Choose two resources to take from the bank.',
      play: 'Play',
      close: 'Close',
      cards: {
    ...
    discard: {
      title: 'Discard cards',
      prompt: 'The robber struck! Discard {count} cards.',
      cardsHint: 'Click cards to select or unselect them',
      clickAdd: 'Click to select',
      clickRemove: 'Click to unselect',
    ...
    gameOver: {
      ...
      winner: '{player} wins!',
      winnerYou: 'You win!',
      turns: 'Turns played: {turns}',
      finalVp: 'Final victory points',
      playAgain: 'New game',
      rules: 'Rules',
    },
    rulesPanel: {
      title: 'Rules',
      goal: 'First to 10 victory points wins. You can only win on your own turn.',
      ...
      robberTitle: 'The 7 and the robber',
      robberBody:
        'Roll a 7 and every player with more than 7 cards discards half (rounded down). Then move the robber to any hex and steal one card from a player with a settlement or city there. The robber also blocks that hex from producing.',
      ...
      devCards: [
        ...
        'Monopoly: take every copy of one resource from all opponents.',
        'Victory Point: worth 1 VP, kept hidden until the end.',
      ],
      armyRoadTitle: 'Longest Road and Largest Army',
      armyRoadBody:
        'The first player with a road of 5 or more segments holds Longest Road (2 VP). The first player with 3 knights played holds Largest Army (2 VP). Beat the holder\u2019s total to steal the badge.',
      harbourTitle: 'Harbours',
      harbourBody:
        'Build on a harbour to trade at 2:1 for the shown resource or 3:1 at a general harbour. Otherwise the bank trades at 4:1.',
      winTitle: 'Winning',
      winBody: 'Reach 10 victory points on your turn and the game ends immediately.',
    },
    log: {
