...
export const en = {
  ...
  legal: {
    ...
    terms: {
      ...
      s5b: 'Content on this Site is provided for informational purposes only and does not constitute legal advice. While I make reasonable efforts to ensure accuracy, I make no representations as to the completeness or currency of information provided.',
    ...
    privacy: {
      ...
      s4p2: 'Reasonable technical and organisational security measures are in place to protect your data from unauthorised access or disclosure.',
      s5h: '5. Retention',
